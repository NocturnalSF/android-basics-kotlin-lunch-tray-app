...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        //  entree price.
        if (_entree.value != null) previousEntreePrice =
            menuItems[_entree.value.toString()]?.price!!
        ...
        if (_entree.value != null) _subtotal.value = _subtotal.value!! - previousEntreePrice
        ...
        menuItems[_entree.value.toString()]?.let { updateSubtotal(it.price) }
    }
    ...
    fun setSide(side: String) {
        ...
        if (_side.value != null) previousSidePrice =
            menuItems[_side.value.toString()]?.price!!
        ...
        if (_side.value != null) _subtotal.value = _subtotal.value!! - previousSidePrice
        ...
        menuItems[_side.value.toString()]?.let { updateSubtotal(it.price) }
    }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        if (_accompaniment.value != null) previousAccompanimentPrice =
            menuItems[_accompaniment.value.toString()]?.price!!
        ...
        menuItems[_accompaniment.value.toString()]?.let { updateSubtotal(it.price) }
    }
