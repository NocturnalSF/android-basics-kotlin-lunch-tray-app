...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        if (_subtotal.value != null) _subtotal.value = _subtotal.value!!.minus(previousEntreePrice)
    ...
    fun setSide(side: String) {
        ...
        if (_side.value != null) _subtotal.value = _subtotal.value!!.minus(previousSidePrice)
